...
public class AdaptadorRecycler extends RecyclerView.Adapter<AdaptadorRecycler.MiHolder> {
    ...
    public void onBindViewHolder(@NonNull MiHolder miHolder, int i) {
        ...
        Glide.with(context).load(equipo.getEquipacion()).into(miHolder.getImagenCamiseta());
        Glide.with(context).load(equipo.getEscudo()).into(miHolder.getImagenEscudo());
        Glide.with(context).load(equipo.getEstadio()).into(miHolder.getImagenEstadio());
    ...
    class MiHolder extends RecyclerView.ViewHolder {
        ...
        private MiHolder(@NonNull View itemView) {
            ...
            imagenCamiseta = itemView.findViewById(R.id.camiseta);
            imagenEscudo = itemView.findViewById(R.id.escudo);
            imagenEstadio = itemView.findViewById(R.id.estadio);
